...
ActiveRecord::Schema[8.1].define(version: 2026_04_14_090000) do
  ...
  create_table "colleges", force: :cascade do |t|
    ...
    t.integer "max_items_per_user", default: 100, null: false
    t.string "name"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.check_constraint "char_length(pseudo::text) <= 15", name: "users_pseudo_max_length"
  end
